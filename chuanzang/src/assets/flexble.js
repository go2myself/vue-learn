!(function(e, t) {
  ...
  e.addEventListener('resize', function() { clearTimeout(a), a = setTimeout(i, 300) }, !1), e.addEventListener('pageshow', function(e) { e.persisted && (clearTimeout(a), a = setTimeout(i, 300)) }, !1), r.readyState === 'complete' ? r.body.style.fontSize = 12 * m + 'px' : r.addEventListener('DOMContentLoaded', function(e) { r.body.style.fontSize = 12 * m + 'px' }, !1), i(), s.dpr = e.dpr = m, s.refreshRem = i, s.rem2px = function(e) {
